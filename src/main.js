...
const store = new Vuex.Store({
  state: {
	  	materials: [
			...
			{id: 6, type: "Image", keywords: "City, country, ancap, slavacapitalizmu", name: "Singapore is THICC", content: "https://cogitogroup.com.au/wp-content/uploads/Singapore-1366-700-Landing.jpg", subType: "City", social: {comments: 1, likes: 69, views: 228}},
			{id: 7, type: "Text", keywords: "", name: "Blo-blo", content: "Bla Bla Bla B saD asdhasjk ashajksdjkadjkasjhkd ajksadkasdhkajshk jsdkasdkasdjahdkj hajksdhajkhdjkasjkhaskdhaksdaksjdkasdkas la Lorem Ipsum Dolor Bla Bla", subType: "Long poem", social: {comments: 12, likes: 21369, views: 2288}},
