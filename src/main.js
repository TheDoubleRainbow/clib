...
const store = new Vuex.Store({
  state: {
	  	materials: [
			...
			{id: 4, type: "Video", name: "An another meme", content: "https://www.youtube.com/watch?v=VbUMVq4pY94&index=67&list=LLrOrZVl41HwptjZDGieIGyQ", subType: "YouTube", social: {comments: 122, likes: 6913, views: 228}},
